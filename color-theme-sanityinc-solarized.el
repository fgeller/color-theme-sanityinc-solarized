...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (anything-apt-installed ((,class (:foreground ,blue))))
     (anything-bmkext-file ((,class (:foreground ,blue))))
     (anything-bmkext-gnus ((,class (:foreground ,blue))))
     (anything-bmkext-info ((,class (:foreground ,blue))))
     (anything-bmkext-man ((,class (:foreground ,blue))))
     (anything-bmkext-no--file ((,class (:foreground ,blue))))
     (anything-bmkext-w3m ((,class (:foreground ,blue))))
     ...
     (anything-candidate-number ((,class (:foreground nil :background nil))))
     ...
     (anything-ff-file ((,class (:foreground ,blue))))
     (anything-ff-invalid-symlink ((,class (:foreground ,blue))))
     (anything-ff-prefix ((,class (:foreground ,blue))))
     (anything-ff-symlink ((,class (:foreground ,blue))))
     (anything-gentoo-match-face ((,class (:foreground ,blue))))
     (anything-grep-file ((,class (:foreground ,blue))))
     (anything-grep-finish ((,class (:foreground ,blue))))
     (anything-grep-lineno ((,class (:foreground ,blue))))
     (anything-grep-match ((,class (:foreground ,blue))))
     (anything-grep-running ((,class (:foreground ,blue))))
     (anything-header ((,class (:foreground ,blue))))
     (anything-isearch-match ((,class (:foreground ,blue))))
     ...
     (mode-line ((,class (:foreground ,faintest :background ,alt-background :weight normal :box nil))))

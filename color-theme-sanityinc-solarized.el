...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (mode-line ((,class (:foreground ,faintest :background ,background :weight normal :box nil :underline nil :overline t))))
     (mode-line-buffer-id ((,class (:inherit mode-line :foreground ,blue :background nil :weight normal))))
     (mode-line-inactive ((,class (:inherit mode-line :foreground nil :background nil :weight normal :box nil))))
     (mode-line-emphasis ((,class (:inherit mode-line :foreground ,strong))))
     (mode-line-highlight ((,class (:inherit mode-line :foreground ,magenta :box nil :weight bold))))
     ...
     (hl-line ((,class (:background ,alt-background :inverse-video nil :underline nil :overline nil :weight normal))))
     ...
     (diff-file-header ((,class (:foreground ,normal :background nil :weight normal))))
     (diff-hunk-header ((,class (:foreground ,faintest))))
     ...
     (ediff-even-diff-C ((,class (:foreground nil :background nil))))
     (ediff-even-diff-Ancestor ((,class (:foreground nil :background nil))))
     (ediff-odd-diff-A ((,class (:foreground nil :background nil))))
     (ediff-odd-diff-B ((,class (:foreground nil :background nil))))
     (ediff-odd-diff-C ((,class (:foreground nil :background nil))))
     (ediff-odd-diff-Ancestor ((,class (:foreground nil :background nil))))
     ...
     (magit-log-author ((,class (:foreground ,green :background nil))))
     (magit-log-graph ((,class (:foreground ,faintest))))
     (magit-log-sha1 ((,class (:foreground ,faintest))))
     ...
     (org-agenda-date ((,class (:foreground ,blue :underline nil :weight normal))))
     ...
     (org-table ((,class (:foreground ,violet :family "Consolas"))))
